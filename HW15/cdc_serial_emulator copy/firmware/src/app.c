...
void __ISR(_TIMER_2_VECTOR, IPL5SOFT) PWMcontroller(void) { 
    OC1RS = mycommandRight;  //right
    OC2RS = 3000-mycommandLeft;  //left, 0 is 100% output, 3000 is 0% output
    IFS0bits.T2IF = 0;
}
        ...
        case APP_STATE_CHECK_CDC_READ:
            ...
            if(appData.isReadComplete == true)
            {
                ...
                if (qq == 320) {
                    ...
                    mycommandRight = 3000 - 3000*(qq-320)/320.0;
                }
                else if (qq < 320) { 
                    mycommandLeft = 3000 - 3000*(320-qq)/320.0;
                }
//                if (qq == 320) {    //center line
//                    mycommandRight = 3000;
//                    mycommandLeft = 3000;
//                }
//                else if (qq < 320 && qq >= 270) {   //left
//                    mycommandRight = 2500;
//                    mycommandLeft = 2000;
//                }
//                else if (qq < 270 && qq >= 220) {   //left
//                    mycommandRight = 2000;
//                    mycommandLeft = 1800;
//                }
//                else if (qq < 220 && qq >= 170) {   //left
//                    mycommandRight = 2000;
//                    mycommandLeft = 1500;
//                }
//                else if (qq < 170) {    //left
...
//                    mycommandLeft = 1000;
//                }
//                else if (qq <= 370 && qq > 320) {   //right
//                    mycommandRight = 2000;
//                    mycommandLeft = 2500;
//                }
//                else if (qq <= 420 && qq > 370) {   //right
//                    mycommandRight = 1800;
//                    mycommandLeft = 2000;
//                }
//                else if (qq <= 470 && qq > 420) {   //right
//                    mycommandRight = 1500;
//                    mycommandLeft = 2000;
//                }
//                else if (qq > 470) {    //right
//                    mycommandRight = 1000;
//                    mycommandLeft = 2000;
//                }
            }
